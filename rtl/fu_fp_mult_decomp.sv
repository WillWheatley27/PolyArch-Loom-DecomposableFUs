// fu_fp_mult_decomp.sv -- STUB (RED). Handshake only; out_data is a non-FP integer
// combine (XOR), so it fails the FP golden on essentially all vectors. Replaced by
// the shared IEEE-754 multiply core in GREEN.

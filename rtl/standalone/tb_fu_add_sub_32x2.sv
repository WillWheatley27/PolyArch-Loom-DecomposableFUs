// Self-checking Verilator TB for fu_add_sub_32x2.
module tb_fu_add_sub_32x2 #(
  ...
  function automatic logic [63:0] golden(input logic [1:0] ops,
                                         input logic [63:0] x,
                                         input logic [63:0] z);
    logic [63:0] r;
    begin
  ...
  task automatic check_vec(input logic [1:0] ops,
  ...
  initial begin
    ...
    // Carry/borrow must not cross the 32-bit boundary.
    check_vec(2'b00, 64'h0000_0000_FFFF_FFFF, 64'h0000_0000_0000_0001);
    check_vec(2'b11, 64'h0000_0001_0000_0000, 64'h0000_0000_0000_0001);
    check_vec(2'b10, 64'h0000_0001_0000_0000, 64'h0000_0001_0000_0001);

    // Backpressure and an incomplete input join.
    op_sel = 2'b01; a = 64'hDEAD_BEEF_CAFE_F00D; b = 64'h0123_4567_89AB_CDEF;
    ...
    if (errors == 0) $display("PASS: fu_add_sub_32x2, %0d random vectors", NRAND);
    else begin $display("FAIL: fu_add_sub_32x2 %0d mismatches", errors); $fatal(1); end
    $finish;
  end
endmodule : tb_fu_add_sub_32x2

// Self-checking Verilator TB for fu_mult_16x4.
module tb_fu_mult_16x4 #(
  ...
  function automatic logic [63:0] golden(input logic [63:0] x,
    ...
    begin
      r = '0;
      for (int l = 0; l < 4; l++) r[l*16 +: 16] = x[l*16 +: 16] * z[l*16 +: 16];
      golden = r;
    end
  endfunction
  ...
  initial begin
    ...
    check_vec(64'hFFFF_FFFF_FFFF_FFFF, 64'h0001_0001_0001_0001);
    check_vec(64'h1234_5678_9ABC_DEF0, 64'h0002_0003_0004_0005);
    ...
    if (errors == 0) $display("PASS: fu_mult_16x4, %0d random vectors", NRAND);
    else begin $display("FAIL: fu_mult_16x4 %0d mismatches", errors); $fatal(1); end
    $finish;
  end
endmodule : tb_fu_mult_16x4

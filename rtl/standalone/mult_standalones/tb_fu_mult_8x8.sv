// Self-checking Verilator TB for fu_mult_8x8.
module tb_fu_mult_8x8 #(
  ...
  function automatic logic [63:0] golden(input logic [63:0] x,
    ...
    begin
      r = '0;
      for (int l = 0; l < 8; l++) r[l*8 +: 8] = x[l*8 +: 8] * z[l*8 +: 8];
      golden = r;
    end
  endfunction
  ...
  initial begin
    ...
    check_vec(64'h0000_0000_0000_00FF, 64'h0101_0101_0101_0101);
    check_vec(64'hFFFF_FFFF_FFFF_FFFF, 64'h0202_0202_0202_0202);
    check_vec(64'h1122_3344_5566_7788, 64'h0102_0304_0506_0708);
    ...
    if (errors == 0) $display("PASS: fu_mult_8x8, %0d random vectors", NRAND);
    else begin $display("FAIL: fu_mult_8x8 %0d mismatches", errors); $fatal(1); end
    $finish;
  end
endmodule : tb_fu_mult_8x8

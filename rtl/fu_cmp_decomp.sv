// fu_cmp_decomp.sv -- STUB (RED). Handshake only; out_data = in_data_0 & in_data_1 (not a
// compare), fails the golden. Replaced by the shared segmented comparator in GREEN.

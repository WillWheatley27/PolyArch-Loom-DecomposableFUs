# SAED14nm synthesis for fixed-lane barrel-shift bank baselines.
# Standalone packed units: two 32-bit or four 16-bit lanes; no runtime mode.
...
set OUT_DIR ${ROOT}/synth/standalone/barrel_shift_standalones
...
run_corner ${ROOT}/rtl/standalone/barrel_shift_standalones/fu_barrel_shift_32x2.sv fu_barrel_shift_32x2 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/barrel_shift_standalones/fu_barrel_shift_32x2.sv fu_barrel_shift_32x2 area  0.400 1 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/barrel_shift_standalones/fu_barrel_shift_16x4.sv fu_barrel_shift_16x4 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/barrel_shift_standalones/fu_barrel_shift_16x4.sv fu_barrel_shift_16x4 area  0.400 1 $OUT_DIR
quit

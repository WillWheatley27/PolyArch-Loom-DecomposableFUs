# SAED14nm synthesis for fixed-lane integer comparison baselines.
# Standalone packed units: 2x32, 4x16, and 8x8; no runtime mode or cross-lane compare.
...
set OUT_DIR ${ROOT}/synth/standalone/cmp_standalones
...
run_corner ${ROOT}/rtl/standalone/cmp_standalones/fu_cmp_32x2.sv fu_cmp_32x2 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/cmp_standalones/fu_cmp_32x2.sv fu_cmp_32x2 area  0.450 1 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/cmp_standalones/fu_cmp_16x4.sv fu_cmp_16x4 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/cmp_standalones/fu_cmp_16x4.sv fu_cmp_16x4 area  0.450 1 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/cmp_standalones/fu_cmp_8x8.sv  fu_cmp_8x8  speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/cmp_standalones/fu_cmp_8x8.sv  fu_cmp_8x8  area  0.450 1 $OUT_DIR
quit

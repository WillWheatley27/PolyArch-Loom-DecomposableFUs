# SAED14nm synthesis for the fixed-lane integer multiply-low baselines.
# Designs are standalone packed-lane units: no runtime mode and no cross-lane product terms.
...
set OUT_DIR ${ROOT}/synth/standalone/mult_standalones
...
run_corner ${ROOT}/rtl/standalone/mult_standalones/fu_mult_32x2.sv fu_mult_32x2 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/mult_standalones/fu_mult_32x2.sv fu_mult_32x2 area  0.800 1 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/mult_standalones/fu_mult_16x4.sv fu_mult_16x4 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/mult_standalones/fu_mult_16x4.sv fu_mult_16x4 area  0.800 1 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/mult_standalones/fu_mult_8x8.sv  fu_mult_8x8  speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/mult_standalones/fu_mult_8x8.sv  fu_mult_8x8  area  0.800 1 $OUT_DIR
quit

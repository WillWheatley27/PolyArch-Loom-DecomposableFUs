# SAED14nm synthesis for the 64/32 Karatsuba multiply-low FU.
...
set RTL     ${ROOT}/rtl/fu_mult_karatsuba_64_32.sv
set OUT_DIR ${ROOT}/synth/work_mult_karatsuba_64_32
...
proc run_corner {rtl design tag max_delay area_effort out_dir} {
  ...
  if {$area_effort} { compile_ultra -area_high_effort_script -no_autoungroup } \
  else              { compile_ultra -no_autoungroup }
...
run_corner $RTL fu_mult_karatsuba_64_32 speed 0.010 0 $OUT_DIR
run_corner $RTL fu_mult_karatsuba_64_32 area  0.800 1 $OUT_DIR
quit

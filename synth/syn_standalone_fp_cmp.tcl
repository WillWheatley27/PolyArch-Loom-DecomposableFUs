# SAED14nm synthesis for fixed-lane IEEE floating-point compare baselines.
# Standalone packed units: 1xFP64, 2xFP32, and 4xFP16; no runtime mode.
...
set OUT_DIR ${ROOT}/synth/standalone/fp_cmp_standalones

# SAED14nm synthesis for fixed-lane integer min/max baselines.
# Designs are standalone packed-lane units: no runtime mode and no cross-lane compare.
...
set OUT_DIR ${ROOT}/synth/standalone/min_max_standalones
...
run_corner ${ROOT}/rtl/standalone/min_max_standalones/fu_min_max_32x2.sv fu_min_max_32x2 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/min_max_standalones/fu_min_max_32x2.sv fu_min_max_32x2 area  0.260 1 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/min_max_standalones/fu_min_max_16x4.sv fu_min_max_16x4 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/min_max_standalones/fu_min_max_16x4.sv fu_min_max_16x4 area  0.260 1 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/min_max_standalones/fu_min_max_8x8.sv  fu_min_max_8x8  speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/min_max_standalones/fu_min_max_8x8.sv  fu_min_max_8x8  area  0.260 1 $OUT_DIR
quit

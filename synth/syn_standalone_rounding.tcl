# SAED14nm synthesis for fixed-format packed FP round-to-integral baselines.
# Standalone units: two fp32 or four fp16 lanes; no runtime format mode.
...
set OUT_DIR ${ROOT}/synth/standalone/rounding_standalones
...
run_corner ${ROOT}/rtl/standalone/rounding_standalones/fu_rounding_32x2.sv fu_rounding_32x2 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/rounding_standalones/fu_rounding_32x2.sv fu_rounding_32x2 area  0.600 1 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/rounding_standalones/fu_rounding_16x4.sv fu_rounding_16x4 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/rounding_standalones/fu_rounding_16x4.sv fu_rounding_16x4 area  0.600 1 $OUT_DIR
quit

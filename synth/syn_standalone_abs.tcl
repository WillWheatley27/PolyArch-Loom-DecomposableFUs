# SAED14nm synthesis for fixed-lane absolute-value baselines.
# Standalone packed units: 2x32 and 4x16; is_float selects integer or FP abs.
...
set OUT_DIR ${ROOT}/synth/standalone/abs_standalones
...
run_corner ${ROOT}/rtl/standalone/abs_standalones/fu_abs_32x2.sv fu_abs_32x2 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/abs_standalones/fu_abs_32x2.sv fu_abs_32x2 area  0.300 1 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/abs_standalones/fu_abs_16x4.sv fu_abs_16x4 speed 0.010 0 $OUT_DIR
run_corner ${ROOT}/rtl/standalone/abs_standalones/fu_abs_16x4.sv fu_abs_16x4 area  0.300 1 $OUT_DIR
quit
